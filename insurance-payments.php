    	...
    	<div class="container">
        	<div class="subbanner-content banner-content">
            	<div class="skew-effect fadeInLeft animated">
                   	<span class="fw-normal"> Insurance &amp; </span> Payments
				</div>
    ...
    <div class="container">
        <div class="row">
            <div class="clearfix">
                ...
                <!-- Section 2 -->
                <div class="col-md-8 marbot40">
                	<h3>List of some health insurance policy Providers </h3>
                    <ul class="two-column list-type1-small fontresize club-logo clearfix">
                        <li> Great West Healthcare </li>
                        <li> HealthNet </li>
                        <li> Medicare </li>
                        <li> AmeriHealth </li>
                        <li> Oxford Liberty both HMO and PPO </li>
                        <li> Vision Service Plan </li>
                        <li> Cigna PPO </li>
                        <li> Broader Health Plan </li>
                        <li> Horizon Blue Cross Blue Shield of NJ PPO </li>
                        <li> Blue Cross Blue Shield PPO (out of state) </li>
                        <li> Oxford Freedom both HMO and PPO </li>
                        <li> Aetna PPO </li>
...
<section class="subbanner-pattern-06 top-bottom-spacing">
    	<div class="container">
        	<div class="row">
          <!-- Content -->
            	<div class="col-md-10 col-md-push-1 col-md-pull-1">
              		<div class="clearfix">
                        ...
                        <h2 class="marbot30 text-white text-center"> We are participating providers for: </h2>
