    	...
    	<div class="row animatedParent animateOnce">
        	<div class="col-md-8 fadeInLeft animated">
                ...
                <div class="panel panel-body marbot40">
                    <h2 class="marbot50"> Case Studies </h2>
                    <div class="clearfix">
                        <div class="row">
                            <div class="col-sm-5 marbot30">
                                <figure>
                    ...
                    <!-- Hidden -->
                      <div data-toggle="lightbox" data-gallery="accura-item1" data-remote="http://placehold.it/1000x1200" data-title="Wavefront LASEK" data-footer="After Lasik, Jessica, Get a life free from Glasess, Contact lenses, see how ?"></div>
                            ...
                            <div class="col-sm-7">
                                <p class="fontresize"> <strong>Patient name :</strong> Jennifer Garner (Princeton, New Jersy) (2010) </p>
                                <p class="fontresize"> <strong>Age :</strong> 27 Years </p>
                                <p class="fontresize"> <strong>Refractive error :</strong> Jennifer Garner (Princeton, New Jersy) (2010) </p>
                                <p class="fontresize"> <strong>Procedure opted :</strong> Intralase </p>
                                <p class="fontresize"> <strong>After lasik vision : </strong> 6/6 both eyes </p>
                            </div>
                        </div>
                        
                        <div class="clearfix marbot30">
                            <div class="table-responsive">
                                <table class="table case-table table-bordered">
                                    <tr>
                                        <th colspan="2">R/E</th>
                                        <th colspan="2">L/E</th>
                                    </tr>
                        ...
                        <div class="clearfix">
                            <p class="fontresize marbot0"> <strong>His Experience :  </strong> </p>
                            <p class="fontresize"> 
                                Best Doctors & best Hospital for eyes. Dr. Steve Williams knows all about the eyes. She got rid of my glasses, I use to feel depressed with my glasses on but now I can see without any extra help!
                            </p>
                        </div>
                    </div>
                    </div>
            ...
            <div class="col-md-4">
            	<aside class="color-box marbot30">
                    <h3 class="marbot40"> Claim as soon as your cover starts </h3>
                ...
                <aside class="panel panel-body marbot40 panel-grey bottom-right">
