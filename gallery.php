    	...
    	<div class="container">
        	<div class="subbanner-content banner-content">
            	<div class="skew-effect fadeInLeft animated">
                   	<span class="fw-normal">Accura</span> Gallery
				</div>
...
<section class="top-bottom-spacing grey-bg">
    <div class="container">
        ...
        <div id="options">
          <ul id="filters" class="option-set clearfix" data-option-key="filter">
            ...
            <li><a href="#" data-option-value=".brown-lift" class="btn btn-type1-reverse">Eye Checkup</a></li>
            <li><a href="#" data-option-value=".eye-care-center" class="btn btn-type1-reverse"> Eyecare Center</a></li>
            <li><a href="#" data-option-value=".surgery" class="btn btn-type1-reverse">Surgery</a></li>
          </ul>
        </div>
    ...
    <div id="portfolio" class="clearfix three-column marbot30">
        ...
        <div class="element transition laser-eye-surgery" data-category="laser-eye-surgery">
        	...
        	<a href="http://placehold.it/1600x1050" data-toggle="lightbox" data-gallery="accura-item1" data-title="Comprehensive Eye Exams" data-footer="Optometrists and ophthalmologists use a wide variety of tests and procedures to examine your eyes">
            
            	<div class="grid image-effect2">
                   	<figure>
                		<img src="http://placehold.it/1600x1050" alt=" " class="img-responsive" />
        ...
        <div class="element transition brown-lift" data-category="brown-lift">
            ...
            <a href="http://placehold.it/1600x1050" data-toggle="lightbox" data-gallery="accura-item1" data-title="Drooping Eyelids" data-footer="We reduced bagginess from her lower eyelids and made her feel young and better">
        ...
        <!-- Accura Item 3 -->
        <div class="element transition eye-care-center" data-category="eye-care-center">
        
        	<a href="http://placehold.it/1600x1050" data-toggle="lightbox" data-gallery="accura-item1" data-title="Steve John Lasik Patient quotes" data-footer="Very good service, Was very helpful, Doctor Steve responds promptly. I am very happy that i signed up to Accura Vision care service.">
        ...
        <!-- Accura Item 4 -->
        <div class="element transition surgery" data-category="surgery">
        	
            <a href="http://placehold.it/1600x1050" data-toggle="lightbox" data-gallery="accura-item1" data-title="Specialized Doctors" data-footer="Dr. Williams takes lots of time to explain how to manage your condition and understand how it affects your vision and your eyes">
        ...
        <div class="element transition eye-care-center" data-category="eye-care-center">
            ...
            <a href="http://placehold.it/720x480" data-toggle="lightbox" data-gallery="accura-item1" data-title="Letterpress asymmetrical" data-footer="Chillwave hoodie ea gentrify aute sriracha consequat">
            
            	<div class="grid image-effect2">
                   	<figure>
                		<img src="http://placehold.it/720x480" alt=" " class="img-responsive" />
                        <figcaption><i class="fa flaticon-symbols-1 gallery-icon transition"></i></figcaption>
                    </figure>
                </div>
			</a>
        ...
        <div class="element transition laser-eye-surgery" data-category="laser-eye-surgery">
            ...
            <a href="http://placehold.it/1600x1050" data-toggle="lightbox" data-gallery="accura-item1" data-title="Letterpress asymmetrical" data-footer="Chillwave hoodie ea gentrify aute sriracha consequat">
