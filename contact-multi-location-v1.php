    ...
    <div class="container">
        <div class="subbanner-content banner-content">
            <div class="skew-effect fadeInLeft animated">
                <span class="fw-normal"> Multi</span> Locations
            </div>
...
<section class="top-bottom-spacing grey-bg">
    <div class="container animatedParent animateOnce">
        ...
        <div id="portfolio" class="clearfix marbot40 three-column fadeInUp animated">
            <!-- Accura Item 1 -->
            <div class="element">
            	<a href="contact-single-v1.php" class="grid image-effect2">
                	<figure>
                ...
                <div class="panel panel-body marbot0">
                    <div class="media media-base-align">
                        <span class="media-left">
                        	<i class="flaticon-technology-6 location-icon color-light"></i>
                        </span>
                        <div class="media-body">
                        	<h3> Alabama, New York </h3>
                    ...
                    <div class="media media-base-align">
                        ...
                        <div class="media-body">
                            <div class="call"><a href="#" class="transition reverse"> +1-234-567-8900 </a> </div> 
                        </div>
                    </div> 
                </div>
            </div>
            ...
            <div class="element">
                ...
                <div class="panel panel-body marbot0">
                    <div class="media media-base-align">
                        ...
                        <div class="media-body">
                        	<h3> Phoneix, Arizona </h3>
                        	<p class="fontresize marbot10">
                               Healthcare Center <br />
                               #123, 9th Avenue,<br />
                               Phoneix, Arizona 36310.
                            </p>
                        </div>
                    </div>
                    <div class="media media-base-align">
            ...
            <div class="element">
                ...
                <div class="panel panel-body marbot0">
                    <div class="media media-base-align">
                        ...
                        <div class="media-body">
                        	<h3> Trenton, New Jersy </h3>
                        	<p class="fontresize marbot10">
                               The  Royal Park <br />
                                #123, 4th street, Royal Avenue,<br />
                                Trenton, NJ 36310.
                            </p>
                        </div>
                    </div>
                ...
                <div class="panel panel-body marbot0">
                    <div class="media media-base-align">
                        ...
                        <div class="media-body">
                        	<h3> Houston, Texas</h3>
                        	<p class="fontresize marbot10">
                                Whitehorse Building <br />
                                #123, 8th Main Road,<br />
                                Houston, TX 36310.
                            </p>
                        </div>
                    </div>
