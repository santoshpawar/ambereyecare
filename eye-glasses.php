...
<section class="animatedParent animateOnce subbanner subbanner-image subbanner-pattern-07 subbanner-type-2 subbanner-type-2-btn">
    	<div class="container">
        	<div class="subbanner-content banner-content">
            	<div class="skew-effect fadeInLeft animated">
                   	<span class="fw-normal">Glasses &amp;</span> Lenses
				</div>
        ...
        <div class="row">
            <div class="clearfix">
                ...
                <div class="col-md-4 marbot40">
                	<h1>
                    	<span class="fw-normal">Glass &amp; </span>Lens Brand
                    </h1>
                    <p class="fontresize marbot0"> If there is a specific designer frame that you are looking for, please call and speak to one of our frame experts, who will be more than happy to assist you</p>
                </div>
                <!-- // Section 1 -->
                ...
                <div class="col-md-4 marbot40">
                    ...
                    <ul class="list-type1-small fontresize">
                        <li> Payment is expected when services are rendered and a deposit is required on all eyeglasses and contact lenses ordered </li>
                        <li> We accept MC, Visa, Master cards, Debit cards, Credit cards, Checks and Cash. </li>
                    </ul>
                </div>
                <!-- // Section 2 -->
                ...
                <!-- Section 3 -->
                <div class="col-md-4 marbot40">
                	<h3> Claim as soon as your cover starts </h3>
                    <ul class="list-type1-small fontresize">
...
<section class="subbanner-pattern-07 top-bottom-spacing">
        <div class="container">
            ...
            <h2 class="marbot30 text-white text-center">We are proud to offer a below eyeglass lenses </h2>
            
            <ul class="club-logo four-column clearfix marbot30">
                <li>
                    <div class="client-logo-background transition">
                        <img src="assets/images/client-logo1.png" alt=" " class="img-responsive center-block vertical-center transition">
                    </div>
                </li>
                <li>
                    <div class="client-logo-background transition">
                        <img src="assets/images/client-logo2.png" alt=" " class="img-responsive center-block vertical-center transition">
                    </div>
                </li>
                <li>
                    <div class="client-logo-background transition">
                        <img src="assets/images/client-logo3.png" alt=" " class="img-responsive center-block vertical-center transition">
                    </div>
                </li>
                <li>
                    <div class="client-logo-background transition">
                        <img src="assets/images/client-logo4.png" alt=" " class="img-responsive center-block vertical-center transition">
                    </div>
                </li>
                <li>
                    <div class="client-logo-background transition">
                        <img src="assets/images/client-logo5.png" alt=" " class="img-responsive center-block vertical-center transition">
                    </div>
                </li>
                <li>
                    <div class="client-logo-background transition">
                        <img src="assets/images/client-logo6.png" alt=" " class="img-responsive center-block vertical-center transition">
                    </div>
                </li>
                <li>
                    <div class="client-logo-background transition">
        ...
        <div class="clearfix">
            ...
            <div class="row marbot20">
            	<div class="col-md-4">
                    ...
                    <p class="font-resizer">Restore Vision Centers believes that everyone deserves to love their vision.</p>
                </div>
                <div class="col-md-4">
                	<p class="font-resizer">
                    ...
                    <p class="font-resizer">We make eyes changes to lovely look and give best vision to see the world. </p>
                </div>	
                <div class="col-md-4">
                	<p class="font-resizer">
                    ...
                    <p class="font-resizer marbot0">All Laser Lasik, Cornea & Glaucoma, Laser Cataract Surgery, Brow lift services. </p>
                </div>
            </div>
        </div>
    </div>
