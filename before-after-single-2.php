                ...
                <div class="row clearfix animatedParent animateOnce">
                    <div class="col-md-6 marbot30-md-xs fadeInLeft animated">
                        ...
                        <div class="before-after">
                            <ul class="bxslider">
                                <li><img src="http://placehold.it/1000x1200" alt=" " title="Before" /></li>
                                <li><img src="http://placehold.it/1000x1200" alt=" " title="After" /></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6 fadeInRight animated">
                        ...
                        <ul class="list-unstyled list-group marbot30">
                            <li class="list-group-item">Better night vision</li>
                            <li class="list-group-item">Better quality of vision</li>
                            <li class="list-group-item">Less chance of a laser enhancement</li>
                            <li class="list-group-item">More Accurate</li>
                        </ul>
                        ...
                        <ul class="list-type1-small fontresize">
                        	<li> <strong>Patient name :</strong> Jennifer Garner (Princeton, New Jersy) (2010) </li>
                            <li> <strong>Age :</strong> 27 Years </li>
                            <li> <strong>Refractive error :</strong> Jennifer Garner (Princeton, New Jersy) (2010) </li>
                            <li> <strong>Procedure opted :</strong> Intralase </li>
                            <li> <strong>After lasik vision : </strong> 6/6 both eyes </li>
                        </ul>
